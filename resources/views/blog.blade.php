                        ...
                        <div id="posts">
                            ...
                            <div class="entry bf-image clearfix">
                                <div class="entry-image">
                                    <a href="images/blog/full/17.jpg" data-lightbox="image"><img class="image_fade" src="{{$post->image}}" alt="Standard Post with Image"></a>
                                </div>
                                ...
                                <ul class="entry-meta clearfix">
                                    ...
                                    <li><a href="{{route('blog.post',$post)}}#comments"><i class="icon-comments"></i> 13 Comments</a></li>
