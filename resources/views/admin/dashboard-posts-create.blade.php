                ...
                <div class="container-fluid">
                    ...
                    <form  method="post" action="{{route('dashboard.post.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="title" aria-describedby="" placeholder="Enter post title">
                        </div>
                        <div class="form-group">
                            <label for="product_name">post Author</label>
                            <input type="text" name="author" class="form-control" id="author" aria-describedby="" placeholder="Enter post author">
                        </div>
